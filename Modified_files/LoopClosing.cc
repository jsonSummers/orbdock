...
// Jason - changes
std::ofstream loop_log("loop_closure_log.txt", std::ios::app);
// end changes
        ...
        if(CheckNewKeyFrames())
        {
            ...
            if(bFindedRegion)
            {
                ...
                if(mbLoopDetected)
                {
                    ...
                    // Jason - changes
                    loop_log << "Loop detected at keyframe " << mpCurrentKF->mnId << " matching with keyframe " << mpLoopMatchedKF->mnId << std::endl;
                    // end changes
                    ...
                    if(mpCurrentKF->GetMap()->IsInertial())
                    {
                        ...
                        // Jason - changes
                        loop_log << "Pose adjustment phi: " << phi.transpose() << std::endl;
                        // end changes
                    ...
                    if (bGoodLoop) {
                        ...
                        // Jason changes
                        loop_log << "Good loop closure confirmed" << std::endl;
                        // end changes
