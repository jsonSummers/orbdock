...
// Jason - changes
std::ofstream tracking_log("tracking_log.txt", std::ios::app);
// changes end
...
void Tracking::Track()
{
    ...
    // Jason - changes 
        // Log tracking status for each frame
    switch (mState) {
        case NO_IMAGES_YET:
            tracking_log << "Frame " << mCurrentFrame.mnId << ": NO_IMAGES_YET" << std::endl;
            break;
        case NOT_INITIALIZED:
            tracking_log << "Frame " << mCurrentFrame.mnId << ": NOT_INITIALIZED" << std::endl;
            break;
        case OK:
            tracking_log << "Frame " << mCurrentFrame.mnId << ": OK" << std::endl;
            break;
        case LOST:
            tracking_log << "Frame " << mCurrentFrame.mnId << ": LOST" << std::endl;
            break;
    }
    // Changes end
